...
st.title("Image processing functions with openCV ") 
...
if uploaded_file is not None: 
    ...
    nav= st.sidebar.radio("Select",["original","RGB","Grayscale","Threshold","brightness/contrast","shape"]) 
